function Strings( config ) {
	...
	const values = {
		...
		en: {
			...
			'sidebar/object/reset': 'Reset Actions',
			'sidebar/object/wasm': 'WASM Operations',
			'sidebar/object/wasmOpSelector': 'Selector',
			'sidebar/object/wasmOpSelectedDeleter': 'Delete Seleted',
			'sidebar/object/wasmOpSelectedInverter': 'Inverte Selected',
			'sidebar/object/wasmFillholes': 'Fill All Holes',
			'sidebar/object/wasmOpFixUndercuts': 'Fix Undercuts',
			'sidebar/object/wasmOpSegmentByPoints': 'Segment By Points',
			'sidebar/object/wasmOpThickenMesh': 'Thicken Mesh',
			'sidebar/object/wasmOpLoadFromThreeJS': 'Load Mesh From ThreeJS',
			'sidebar/object/wasmOpLoadFromThreeJSArray': 'Load Mesh From ThreeJS Array',
			...
			'sidebar/geometry/objectActions': 'Object Actions',
		...
		zh: {
			...
			'sidebar/object/reset': '重置操作',
			'sidebar/object/wasm': 'WASM 操作',
			'sidebar/object/wasmOpSelector': '选择封闭曲线',
			'sidebar/object/wasmOpSelectedDeleter': '删除选中部分',
			'sidebar/object/wasmOpSelectedInverter': '反转选中',
			'sidebar/object/wasmOpFixUndercuts': '修复倒凹',
			'sidebar/object/wasmOpSegmentByPoints': '选点分割',
			'sidebar/object/wasmFillholes': '修补全部孔洞',
			'sidebar/object/wasmOpThickenMesh': '制作牙套',
			'sidebar/object/wasmOpLoadFromThreeJS': '加载 ThreeJS 模型',
			'sidebar/object/wasmOpLoadFromThreeJSArray': '从数组加载 ThreeJS 模型',
			...
			'sidebar/geometry/objectActions': '操作对象',
