...
async function createMeshSDK(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("MRJavaScript.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("MRJavaScript.wasm", import.meta.url).href;
}
...
var PThread = {
  ...
  allocateUnusedWorker() {
    ...
    worker = new Worker(new URL("MRJavaScript.js", import.meta.url), {
      "type": "module",
      // This is the way that we signal to the node worker that it is hosting
      // a pthread.
      "workerData": "em-pthread",
...
var SYSCALLS = {
  ...
  writeStat(buf, stat) {
    (growMemViews(), HEAP32)[((buf) >>> 2) >>> 0] = stat.dev;
    checkInt32(stat.dev);
    (growMemViews(), HEAP32)[(((buf) + (4)) >>> 2) >>> 0] = stat.mode;
    checkInt32(stat.mode);
    (growMemViews(), HEAPU32)[(((buf) + (8)) >>> 2) >>> 0] = stat.nlink;
    checkInt32(stat.nlink);
    (growMemViews(), HEAP32)[(((buf) + (12)) >>> 2) >>> 0] = stat.uid;
    checkInt32(stat.uid);
    (growMemViews(), HEAP32)[(((buf) + (16)) >>> 2) >>> 0] = stat.gid;
    checkInt32(stat.gid);
    (growMemViews(), HEAP32)[(((buf) + (20)) >>> 2) >>> 0] = stat.rdev;
  ...
  writeStatFs(buf, stats) {
    (growMemViews(), HEAP32)[(((buf) + (4)) >>> 2) >>> 0] = stats.bsize;
    checkInt32(stats.bsize);
    (growMemViews(), HEAP32)[(((buf) + (40)) >>> 2) >>> 0] = stats.bsize;
    checkInt32(stats.bsize);
    (growMemViews(), HEAP32)[(((buf) + (8)) >>> 2) >>> 0] = stats.blocks;
    checkInt32(stats.blocks);
    (growMemViews(), HEAP32)[(((buf) + (12)) >>> 2) >>> 0] = stats.bfree;
    checkInt32(stats.bfree);
    (growMemViews(), HEAP32)[(((buf) + (16)) >>> 2) >>> 0] = stats.bavail;
    checkInt32(stats.bavail);
    (growMemViews(), HEAP32)[(((buf) + (20)) >>> 2) >>> 0] = stats.files;
    checkInt32(stats.files);
    (growMemViews(), HEAP32)[(((buf) + (24)) >>> 2) >>> 0] = stats.ffree;
    checkInt32(stats.ffree);
    (growMemViews(), HEAP32)[(((buf) + (28)) >>> 2) >>> 0] = stats.fsid;
    checkInt32(stats.fsid);
    (growMemViews(), HEAP32)[(((buf) + (44)) >>> 2) >>> 0] = stats.flags;
    checkInt32(stats.flags);
    // ST_NOSUID
    (growMemViews(), HEAP32)[(((buf) + (36)) >>> 2) >>> 0] = stats.namelen;
...
function ___syscall_fchmod(fd, mode) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(4, 0, 1, fd, mode);
  try {
    FS.fchmod(fd, mode);
    return 0;
  } catch (e) {
...
function ___syscall_getcwd(buf, size) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(7, 0, 1, buf, size);
  buf >>>= 0;
  size >>>= 0;
  try {
    if (size === 0) return -28;
...
function ___syscall_readlinkat(dirfd, path, buf, bufsize) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(14, 0, 1, dirfd, path, buf, bufsize);
  path >>>= 0;
  buf >>>= 0;
  bufsize >>>= 0;
  try {
  ...
  switch (width) {
   case 1:
    return signed ? function(pointer) {
      return this.fromWireType((growMemViews(), HEAP8)[pointer >>> 0]);
    } : function(pointer) {
      return this.fromWireType((growMemViews(), HEAPU8)[pointer >>> 0]);
    };
   ...
   case 2:
    return signed ? function(pointer) {
      return this.fromWireType((growMemViews(), HEAP16)[((pointer) >>> 1) >>> 0]);
    } : function(pointer) {
      return this.fromWireType((growMemViews(), HEAPU16)[((pointer) >>> 1) >>> 0]);
    };

   case 4:
    return signed ? function(pointer) {
      return this.fromWireType((growMemViews(), HEAP32)[((pointer) >>> 2) >>> 0]);
    } : function(pointer) {
      return this.fromWireType((growMemViews(), HEAPU32)[((pointer) >>> 2) >>> 0]);
    };
...
var UTF16ToString = (ptr, maxBytesToRead, ignoreNul) => {
  ...
  HEAPU16).buffer instanceof ArrayBuffer ? (growMemViews(), HEAPU16).subarray(idx >>> 0, endIdx >>> 0) : (growMemViews(), 
...
var _printtt = Module["_printtt"] = makeInvalidEarlyAccess("_printtt");
...
var dynCall_iiffffi = makeInvalidEarlyAccess("dynCall_iiffffi");

var dynCall_viiifffi = makeInvalidEarlyAccess("dynCall_viiifffi");
...
var dynCall_iiff = makeInvalidEarlyAccess("dynCall_iiff");

var dynCall_iijj = makeInvalidEarlyAccess("dynCall_iijj");

var dynCall_iidd = makeInvalidEarlyAccess("dynCall_iidd");

var dynCall_fiii = makeInvalidEarlyAccess("dynCall_fiii");

var dynCall_viifi = makeInvalidEarlyAccess("dynCall_viifi");

var dynCall_viifii = makeInvalidEarlyAccess("dynCall_viifii");
...
var dynCall_iiifiii = makeInvalidEarlyAccess("dynCall_iiifiii");

var dynCall_vifi = makeInvalidEarlyAccess("dynCall_vifi");

var dynCall_iifi = makeInvalidEarlyAccess("dynCall_iifi");
...
var dynCall_viiffi = makeInvalidEarlyAccess("dynCall_viiffi");
...
var dynCall_viiiid = makeInvalidEarlyAccess("dynCall_viiiid");
...
var dynCall_ffff = makeInvalidEarlyAccess("dynCall_ffff");

var dynCall_fifff = makeInvalidEarlyAccess("dynCall_fifff");

var dynCall_diii = makeInvalidEarlyAccess("dynCall_diii");

var dynCall_iiiidd = makeInvalidEarlyAccess("dynCall_iiiidd");

var dynCall_iiidd = makeInvalidEarlyAccess("dynCall_iiidd");

var dynCall_iiiifii = makeInvalidEarlyAccess("dynCall_iiiifii");

var dynCall_viiifii = makeInvalidEarlyAccess("dynCall_viiifii");
...
var dynCall_viiiifi = makeInvalidEarlyAccess("dynCall_viiiifi");

var dynCall_iiiiifi = makeInvalidEarlyAccess("dynCall_iiiiifi");

var dynCall_iiiiif = makeInvalidEarlyAccess("dynCall_iiiiif");

var dynCall_fiiif = makeInvalidEarlyAccess("dynCall_fiiif");

var dynCall_fiiiif = makeInvalidEarlyAccess("dynCall_fiiiif");
...
var dynCall_viiiiiiff = makeInvalidEarlyAccess("dynCall_viiiiiiff");

var dynCall_iiiid = makeInvalidEarlyAccess("dynCall_iiiid");

var dynCall_viij = makeInvalidEarlyAccess("dynCall_viij");

var dynCall_viiij = makeInvalidEarlyAccess("dynCall_viiij");
...
var dynCall_jiiij = makeInvalidEarlyAccess("dynCall_jiiij");

var dynCall_iiij = makeInvalidEarlyAccess("dynCall_iiij");

var dynCall_jiii = makeInvalidEarlyAccess("dynCall_jiii");

var dynCall_viiiij = makeInvalidEarlyAccess("dynCall_viiiij");
...
var dynCall_iiddd = makeInvalidEarlyAccess("dynCall_iiddd");

var dynCall_diiii = makeInvalidEarlyAccess("dynCall_diiii");

var dynCall_vijj = makeInvalidEarlyAccess("dynCall_vijj");

var dynCall_iijjjj = makeInvalidEarlyAccess("dynCall_iijjjj");

var dynCall_iidddd = makeInvalidEarlyAccess("dynCall_iidddd");

var dynCall_diiiii = makeInvalidEarlyAccess("dynCall_diiiii");

var dynCall_viiiiiff = makeInvalidEarlyAccess("dynCall_viiiiiff");

var dynCall_vidi = makeInvalidEarlyAccess("dynCall_vidi");

var dynCall_viijiji = makeInvalidEarlyAccess("dynCall_viijiji");
...
var dynCall_viiiifii = makeInvalidEarlyAccess("dynCall_viiiifii");

var dynCall_viiiiifi = makeInvalidEarlyAccess("dynCall_viiiiifi");

var dynCall_viidi = makeInvalidEarlyAccess("dynCall_viidi");

var dynCall_viidii = makeInvalidEarlyAccess("dynCall_viidii");
...
var dynCall_jiiji = makeInvalidEarlyAccess("dynCall_jiiji");

var dynCall_jiiiji = makeInvalidEarlyAccess("dynCall_jiiiji");
...
function assignWasmExports(wasmExports) {
  ...
  Module["_printtt"] = _printtt = createExportWrapper("printtt", 0);
  ...
  dynCalls["iiiifffi"] = dynCall_iiiifffi = createExportWrapper("dynCall_iiiifffi", 8);
  dynCalls["iiffffi"] = dynCall_iiffffi = createExportWrapper("dynCall_iiffffi", 7);
  dynCalls["viiifffi"] = dynCall_viiifffi = createExportWrapper("dynCall_viiifffi", 8);
  dynCalls["viffffi"] = dynCall_viffffi = createExportWrapper("dynCall_viffffi", 7);
  ...
  dynCalls["vid"] = dynCall_vid = createExportWrapper("dynCall_vid", 3);
  dynCalls["iid"] = dynCall_iid = createExportWrapper("dynCall_iid", 3);
  dynCalls["iiif"] = dynCall_iiif = createExportWrapper("dynCall_iiif", 4);
  dynCalls["iiid"] = dynCall_iiid = createExportWrapper("dynCall_iiid", 4);
  ...
  dynCalls["iiff"] = dynCall_iiff = createExportWrapper("dynCall_iiff", 4);
  dynCalls["iijj"] = dynCall_iijj = createExportWrapper("dynCall_iijj", 4);
  dynCalls["iidd"] = dynCall_iidd = createExportWrapper("dynCall_iidd", 4);
  ...
  dynCalls["iiifi"] = dynCall_iiifi = createExportWrapper("dynCall_iiifi", 5);
  dynCalls["iiifii"] = dynCall_iiifii = createExportWrapper("dynCall_iiifii", 6);
  dynCalls["iiifiii"] = dynCall_iiifiii = createExportWrapper("dynCall_iiifiii", 7);
  dynCalls["vifi"] = dynCall_vifi = createExportWrapper("dynCall_vifi", 4);
  dynCalls["iifi"] = dynCall_iifi = createExportWrapper("dynCall_iifi", 4);
  dynCalls["viiifi"] = dynCall_viiifi = createExportWrapper("dynCall_viiifi", 6);
  dynCalls["iiiifi"] = dynCall_iiiifi = createExportWrapper("dynCall_iiiifi", 6);
  dynCalls["iiiiff"] = dynCall_iiiiff = createExportWrapper("dynCall_iiiiff", 6);
  dynCalls["viiiff"] = dynCall_viiiff = createExportWrapper("dynCall_viiiff", 6);
  dynCalls["iiiif"] = dynCall_iiiif = createExportWrapper("dynCall_iiiif", 5);
  dynCalls["viiff"] = dynCall_viiff = createExportWrapper("dynCall_viiff", 5);
  dynCalls["iiiff"] = dynCall_iiiff = createExportWrapper("dynCall_iiiff", 5);
  dynCalls["viffff"] = dynCall_viffff = createExportWrapper("dynCall_viffff", 6);
  dynCalls["viiffi"] = dynCall_viiffi = createExportWrapper("dynCall_viiffi", 6);
  dynCalls["fiif"] = dynCall_fiif = createExportWrapper("dynCall_fiif", 4);
  dynCalls["iiffff"] = dynCall_iiffff = createExportWrapper("dynCall_iiffff", 6);
  dynCalls["iiiffi"] = dynCall_iiiffi = createExportWrapper("dynCall_iiiffi", 6);
  dynCalls["fif"] = dynCall_fif = createExportWrapper("dynCall_fif", 3);
  dynCalls["viiid"] = dynCall_viiid = createExportWrapper("dynCall_viiid", 5);
  dynCalls["viiif"] = dynCall_viiif = createExportWrapper("dynCall_viiif", 5);
  ...
  dynCalls["viiiid"] = dynCall_viiiid = createExportWrapper("dynCall_viiiid", 6);
  dynCalls["viiiif"] = dynCall_viiiif = createExportWrapper("dynCall_viiiif", 6);
  dynCalls["dii"] = dynCall_dii = createExportWrapper("dynCall_dii", 3);
  ...
  dynCalls["iiiiiif"] = dynCall_iiiiiif = createExportWrapper("dynCall_iiiiiif", 7);
  dynCalls["ffff"] = dynCall_ffff = createExportWrapper("dynCall_ffff", 4);
  dynCalls["fifff"] = dynCall_fifff = createExportWrapper("dynCall_fifff", 5);
  dynCalls["diii"] = dynCall_diii = createExportWrapper("dynCall_diii", 4);
  dynCalls["iiiidd"] = dynCall_iiiidd = createExportWrapper("dynCall_iiiidd", 6);
  dynCalls["iiidd"] = dynCall_iiidd = createExportWrapper("dynCall_iiidd", 5);
  dynCalls["iiiifii"] = dynCall_iiiifii = createExportWrapper("dynCall_iiiifii", 7);
  dynCalls["viiifii"] = dynCall_viiifii = createExportWrapper("dynCall_viiifii", 7);
  dynCalls["viiiiiii"] = dynCall_viiiiiii = createExportWrapper("dynCall_viiiiiii", 8);
  dynCalls["iiiiifii"] = dynCall_iiiiifii = createExportWrapper("dynCall_iiiiifii", 8);
  dynCalls["iifii"] = dynCall_iifii = createExportWrapper("dynCall_iifii", 5);
  dynCalls["viiiifi"] = dynCall_viiiifi = createExportWrapper("dynCall_viiiifi", 7);
  dynCalls["iiiiifi"] = dynCall_iiiiifi = createExportWrapper("dynCall_iiiiifi", 7);
  dynCalls["iiiiif"] = dynCall_iiiiif = createExportWrapper("dynCall_iiiiif", 6);
  dynCalls["fiiif"] = dynCall_fiiif = createExportWrapper("dynCall_fiiif", 5);
  dynCalls["fiiiif"] = dynCall_fiiiif = createExportWrapper("dynCall_fiiiif", 6);
  ...
  dynCalls["viiiiiiff"] = dynCall_viiiiiiff = createExportWrapper("dynCall_viiiiiiff", 9);
  dynCalls["iiiid"] = dynCall_iiiid = createExportWrapper("dynCall_iiiid", 5);
  ...
  dynCalls["diid"] = dynCall_diid = createExportWrapper("dynCall_diid", 4);
  dynCalls["jiij"] = dynCall_jiij = createExportWrapper("dynCall_jiij", 4);
  dynCalls["diiid"] = dynCall_diiid = createExportWrapper("dynCall_diiid", 5);
  dynCalls["jiiij"] = dynCall_jiiij = createExportWrapper("dynCall_jiiij", 5);
  dynCalls["iiij"] = dynCall_iiij = createExportWrapper("dynCall_iiij", 4);
  dynCalls["jiii"] = dynCall_jiii = createExportWrapper("dynCall_jiii", 4);
  dynCalls["viiiij"] = dynCall_viiiij = createExportWrapper("dynCall_viiiij", 6);
  ...
  dynCalls["iifff"] = dynCall_iifff = createExportWrapper("dynCall_iifff", 5);
  dynCalls["fiiii"] = dynCall_fiiii = createExportWrapper("dynCall_fiiii", 5);
  ...
  dynCalls["iiddd"] = dynCall_iiddd = createExportWrapper("dynCall_iiddd", 5);
  dynCalls["diiii"] = dynCall_diiii = createExportWrapper("dynCall_diiii", 5);
  dynCalls["vijj"] = dynCall_vijj = createExportWrapper("dynCall_vijj", 4);
  dynCalls["iijjjj"] = dynCall_iijjjj = createExportWrapper("dynCall_iijjjj", 6);
  dynCalls["iidddd"] = dynCall_iidddd = createExportWrapper("dynCall_iidddd", 6);
  dynCalls["diiiii"] = dynCall_diiiii = createExportWrapper("dynCall_diiiii", 6);
  dynCalls["viiiiiff"] = dynCall_viiiiiff = createExportWrapper("dynCall_viiiiiff", 8);
  dynCalls["vidi"] = dynCall_vidi = createExportWrapper("dynCall_vidi", 4);
  dynCalls["viijiji"] = dynCall_viijiji = createExportWrapper("dynCall_viijiji", 7);
  dynCalls["j"] = dynCall_j = createExportWrapper("dynCall_j", 1);
  dynCalls["viijj"] = dynCall_viijj = createExportWrapper("dynCall_viijj", 5);
  dynCalls["viiji"] = dynCall_viiji = createExportWrapper("dynCall_viiji", 5);
  dynCalls["viijiii"] = dynCall_viijiii = createExportWrapper("dynCall_viijiii", 7);
  dynCalls["viijii"] = dynCall_viijii = createExportWrapper("dynCall_viijii", 6);
  dynCalls["viiiifii"] = dynCall_viiiifii = createExportWrapper("dynCall_viiiifii", 8);
  dynCalls["viiiiifi"] = dynCall_viiiiifi = createExportWrapper("dynCall_viiiiifi", 8);
  dynCalls["viidi"] = dynCall_viidi = createExportWrapper("dynCall_viidi", 5);
  dynCalls["viidii"] = dynCall_viidii = createExportWrapper("dynCall_viidii", 6);
  ...
  dynCalls["jiiji"] = dynCall_jiiji = createExportWrapper("dynCall_jiiji", 5);
  dynCalls["jiiiji"] = dynCall_jiiiji = createExportWrapper("dynCall_jiiiji", 6);
...
function invoke_viijiji(index, a1, a2, a3, a4, a5, a6) {
  var sp = stackSave();
  try {
    dynCall_viijiji(index, a1, a2, a3, a4, a5, a6);
  } catch (e) {
    stackRestore(sp);
    if (e !== e + 0) throw e;
    _setThrew(1, 0);
